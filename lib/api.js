...
let veilReward = require('./reward.js');
	...
	rpc.call('getbestblockhash', [], function (error, hash) {
		...
		rpc.call('getblockheader', [hash], function (error, header) {
			...
			callback(null, {
				...
				reward: veilReward.minerReward(header.height),
				hash: header.hash
			});
		});
	});
 ...
 **/
/**
 * Shorten a Veil address for the public top 10: the beginning and the end (every address starts with "bv1q").
 **/
